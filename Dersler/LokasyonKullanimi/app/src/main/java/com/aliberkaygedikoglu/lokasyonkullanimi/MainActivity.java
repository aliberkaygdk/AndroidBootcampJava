package com.aliberkaygedikoglu.lokasyonkullanimi;
...
import com.aliberkaygedikoglu.lokasyonkullanimi.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonKonum.setOnClickListener(new View.OnClickListener() {
            @Override
